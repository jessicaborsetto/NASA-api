...
function MyFooter() {
    ...
    return (
        < >
            <div className="mb-10 p-5 container mx-auto text-sm text-gray-500 ">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-10 ">
                    ...
                    <div>
                        ...
                        <Input type="email" color="white" placeholder="Email Address" className="bg-slate-200 p-2 rounded" />
                    </div>
                </div>
                ...
                <hr />
                <div className="grid mt-10 grid-cols-1 md:grid-cols-2 text-center">
                    <div className="my-3">
                        <h6>&copy;2024 Jessica Borsetto. All Rights Reserved. </h6>
                    </div>

                    <div className="socials">

                        <button className="bg-blue-500 p-2 font-semibold text-white inline-flex items-center rounded-full">
                        ...
                        <button className="bg-blue-400 p-2 font-semibold text-white inline-flex items-center rounded-full">
                        ...
                        <button className="bg-red-500 p-2 font-semibold text-white inline-flex items-center rounded-full">
                        ...
                        <button className="bg-blue-600 p-2 font-semibold text-white inline-flex items-center rounded-full">
                        ...
                        <button className="bg-red-600 p-2 font-semibold text-white inline-flex items-center rounded-full">
                        ...
                        <button className="bg-gray-700 p-2 font-semibold text-white inline-flex items-center rounded-full">
